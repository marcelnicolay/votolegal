...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'NoticiaAcesso'
        db.create_table('voto_legal_noticiaacesso', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('noticia', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['voto_legal.Noticia'])),
            ('facebook', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['facebook.FacebookProfile'])),
            ('count', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('voto_legal', ['NoticiaAcesso'])


    def backwards(self, orm):
        # Deleting model 'NoticiaAcesso'
        db.delete_table('voto_legal_noticiaacesso')
