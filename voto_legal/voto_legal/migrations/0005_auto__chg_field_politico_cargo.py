...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Politico.cargo'
        db.alter_column('voto_legal_politico', 'cargo_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['voto_legal.Cargo'], null=True))

    def backwards(self, orm):

        # Changing field 'Politico.cargo'
        db.alter_column('voto_legal_politico', 'cargo_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['voto_legal.Cargo']))
