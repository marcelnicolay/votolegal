...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Politico.casa_governamental'
        db.add_column('voto_legal_politico', 'casa_governamental',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['voto_legal.CasaGovernamental'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Politico.casa_governamental'
        db.delete_column('voto_legal_politico', 'casa_governamental_id')
