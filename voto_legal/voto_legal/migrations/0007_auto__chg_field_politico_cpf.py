...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Politico.cpf'
        db.alter_column('voto_legal_politico', 'cpf', self.gf('django.db.models.fields.CharField')(max_length=11, unique=True, null=True))

    def backwards(self, orm):

        # Changing field 'Politico.cpf'
        db.alter_column('voto_legal_politico', 'cpf', self.gf('django.db.models.fields.CharField')(default=None, max_length=11, unique=True))
